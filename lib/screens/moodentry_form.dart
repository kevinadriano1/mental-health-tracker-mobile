...
class _MoodEntryFormPageState extends State<MoodEntryFormPage> {
  final _formKey = GlobalKey<FormState>(); // Form key for validation and state management
  String _mood = "";
  String _feelings = "";
                          ...
                          return AlertDialog(
                            ...
                            content: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  Text('Mood: $_mood'),
                                  Text('Feelings: $_feelings'),  // Displaying _feelings
                                  Text('Mood Intensity: $_moodIntensity'),  // Displaying _moodIntensity
                                ],
                              ),
                            ),
                            actions: [
